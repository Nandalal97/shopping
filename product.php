    ...
    <div id="demo" class="carousel slide my-4" data-ride="carousel">
      ...
      <div class="carousel-inner">
        <div class="carousel-item active">
          <img src="https://static.vecteezy.com/system/resources/previews/002/006/605/original/paper-art-shopping-online-on-smartphone-and-new-buy-sale-promotion-pink-backgroud-for-banner-market-ecommerce-free-vector.jpg" alt="Los Angeles" >
        </div>
    ...
    <div class="product_box">
      ...
      <div class="containe">
        <div class="row">
          ...
          </div><div class="col-md-3 col-sm-6 md">
            <div class="product-grid">
                <div class="product-image">
                    <a href="#" class="image">
